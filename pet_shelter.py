...
class Cat(Animal):
    ...
    def describe(self):
        ...
        if self.is_indoor:
            return super().describe() + f" {self.color} coloring and indoor-only"
        return super().describe() + f" {self.color} coloring and not indoor-only"
...
class ServiceDog(Dog):
    ...
    def describe(self):
        ...
        return super().describe() + f" in {self.service_type} "
...
def main():
    ...
    # TODO: Add a Cat
    shelter.add_animal(Cat("Leo", 8, "black"))
    shelter.add_animal(Cat("Heidi", 14, "cream tabby", False))
    # TODO: Add a Puppy
    shelter.add_animal(Puppy("Willa", 7, "pit bull mix"))
    # TODO: Add a ServiceDog
    shelter.add_animal(ServiceDog("Rosie", 6, "pit bull mix", "anxiety assistance"))
    # TODO: Add a Kitten
    shelter.add_animal(Kitten("Dex", 9, "black"))
    shelter.add_animal(Kitten("Alphecca", 9, "orange tabby"))
